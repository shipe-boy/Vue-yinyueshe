		...
		<div class="footer-wrap" ref="footerWrap">
			...
			<div class="content" ref="content">
				...
				<template v-if="!isBind">
					<!-- <p class="c-message marg">一键绑定～带你进入彩色的音乐世界</p> -->
					<!-- <p class="c-message">赶紧来领取吧</p> -->
					<p class="c-message marg-top">快来领取本书音色曲谱资源吧！</p>
				</template>
				<template v-if="isBind">
					<p class="f-bind-msg">您的音色曲谱已领取～</p>
				</template>
			</div>
			...
			<div class="bind-info" ref="bindInfo">
				...
				<div class="f-info" v-if="isBind">
					<p class="f-info-title">音色曲谱资源已保存至您的玖月琴房账号中赶快下载吧~</p>
...
.bind-wrap .content .c-message.marg-top {
